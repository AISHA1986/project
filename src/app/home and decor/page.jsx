...
export default function page() {
  return (
    <div className=' w-[70%] ml-[180px] h-4/5 mt-[40px] sm:grid-cols-1'>
        ...
        <div>
            <h1 className='font-bold text-4xl mt-6'>Exploring Virtual Reality home decore <br /> home and decor</h1>
        </div>
        <div>
        ...
        <iframe width="1100" height="600" src="https://www.youtube.com/embed/rlZjJhhwyxk?si=rhBRZtZo_D_l5YYF&amp;start=17" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
