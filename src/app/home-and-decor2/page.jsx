  ...
  return (
    <div className=' w-[70%] ml-[180px] h-4/5 mt-[40px] sm:grid-cols-1'>
        ...
        <div className='mt-14 bg-yellow-300 p-12'>
            <p>Furniture selection is another essential aspect of home decoration, as it determines the functionality, comfort, and visual impact of a space. From sofas and chairs to tables and storage units, each piece of furniture should be chosen with consideration of the room layout, scale, and intended use. Multifunctional furniture solutions are particularly valuable in small or multi-purpose spaces, offering versatility and efficiency without sacrificing style. Additionally, mixing different furniture styles, materials, and finishes can add texture and dimension to a room, creating visual intrigue and personality.</p>
        </div>
