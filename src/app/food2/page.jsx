  ...
  return (
    <div className=' w-[70%] ml-[180px] h-4/5 mt-[40px] sm:grid-cols-1'>
        ...
        <div className='mt-14'>
            ...
            <p className='mt-16'>At the heart of chocolate cuisine are the beloved desserts that have become iconic symbols of indulgence and luxury. From classic favorites like chocolate cake, brownies, and chocolate chip cookies to more elaborate treats such as chocolate mousse, truffles, and lava cakes, there is no shortage of delectable options to satisfy a sweet tooth. Whether enjoyed as a comforting homemade treat or savored at a high-end patisserie, chocolate desserts offer a symphony of flavors and textures that tantalize the senses and evoke feelings of blissful indulgence.</p>
        </div>
