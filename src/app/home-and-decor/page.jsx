  ...
  return (
    <div className=' w-[70%] ml-[180px] h-4/5 mt-[40px] sm:grid-cols-1'>
        ...
        <div className='mt-20'>
            ...
            <p className='mt-4'>Furniture selection is a fundamental aspect of interior decor, encompassing not only aesthetics but also functionality and comfort. From sofas and chairs to tables and storage units, each piece of furniture should be chosen with careful consideration of the room layout and intended use. Modular and multifunctional furniture solutions are particularly popular in modern interior design, offering versatility and space-saving benefits for compact living spaces. Additionally, the materials and finishes of furniture pieces contribute to the overall style and ambiance of a room, whether it be the warmth of natural wood or the sleekness of metal and glass</p>
        </div>
